...
import avox.se.mazeRush.events.MovementListener;
...
public final class MazeRush extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLifecycleManager().registerEventHandler(LifecycleEvents.COMMANDS, commands -> new TestCommand().register(commands.registrar(), this));
